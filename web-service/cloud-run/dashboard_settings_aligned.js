// Dashboard update aligned with ACAP settings screen requirements
...
function showSuccessResults(outputs) {
    ...
    // Show Firebase values if available, otherwise show where to get them
    if (outputs.firebaseConfig && typeof outputs.firebaseConfig === 'object') {
        ...
        mainContent += `
            ...
            <div class="result-card">
                ...
                <div class="result-value">
                    <span style="font-family: monospace;">${outputs.firebaseConfig.messagingSenderId || 'Get from Firebase Console'}</span>
            ...
            <div class="result-card">
                ...
                <div class="result-value">
                    <span style="font-family: monospace;">${outputs.firebaseConfig.appId || outputs.firebaseWebAppId || 'Get from Firebase Console'}</span>
    ...
    mainContent += `
        <div class="result-section">
            ...
            <div class="setup-tasks">
                ...
                <div class="task-item">
                    <input type="checkbox" id="task-nextjs" />
                    <label for="task-nextjs">
                        <strong>Update NextJS UI</strong>
                        <span class="task-detail">Add Firebase auth to your live events page</span>
                    </label>
                </div>
            </div>
        </div>
...
// Additional CSS for settings-aligned display
const settingsAlignedStyles = `
<style>
.alert-box {
    background: #fef3c7;
...
.result-section h3.section-title {
    margin-bottom: 1rem;
}
